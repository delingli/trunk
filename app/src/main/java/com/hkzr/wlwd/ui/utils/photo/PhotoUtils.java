package com.hkzr.wlwd.ui.utils.photo;
...
import com.hkzr.wlwd.ui.utils.CommonUtils;
...
public class PhotoUtils {
    ...
    private Uri buildUri(Activity activity) {
        if (CommonUtils.checkSDCard()) {
            return UriUtils.getUri(activity,Environment.getExternalStorageDirectory()).buildUpon().appendPath(CROP_FILE_NAME).build();
        } else {
            return UriUtils.getUri(activity,activity.getCacheDir()).buildUpon().appendPath(CROP_FILE_NAME).build();
        }
    }
