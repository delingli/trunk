...
public class GroupGridViewAdapter extends BaseAdapter {
    ...
    public GroupGridViewAdapter(Context context, List<ApplicationEntity.GroupsBean.ListBeanXX> list) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            convertView = LayoutInflater.from(context).inflate(R.layout.layout_group_item, null);
