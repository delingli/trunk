...
/**
 * �����Ҫ����ˢ��ֱ����canPullDown�з���false��������Զ����غ�����ˢ��û�г�ͻ��ͨ��������
 * β����footerviewʵ���Զ����أ� ������ʹ���в�Ҫ�ٶ�footerview��
...
//		mLoadingView.setBackgroundResource(R.anim.loading_anim);
    ...
    private void changeState(int state) {
        ...
        switch (state) {
            ...
            case NO_MORE_DATA:
                mLoadAnim.stop();
                mLoadingView.setVisibility(View.INVISIBLE);
                mStateTextView.setText(R.string.noMore);
                break;
        }
    }
    ...
    private boolean reachBottom() {
        if (getCount() == 0) {
            ...
            // �����ײ�����픲����ǵ�0����Ҳ����˵item_sign_info���һ��������Զ����أ�����ֻ�ܵ������
