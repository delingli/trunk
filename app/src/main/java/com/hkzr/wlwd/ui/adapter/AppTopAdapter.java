...
public class AppTopAdapter extends BaseAdapter {
    Context context;
    List<ApplicationEntity.TopbarBean.ListBeanX> list;

    public AppTopAdapter(Context context, List<ApplicationEntity.TopbarBean.ListBeanX> list) {
