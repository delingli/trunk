...
public class PagerSlidingTabStrip extends HorizontalScrollView {
    ...
    //	private int tabTextColor = 0xFF8d8c8c;
    private int tabTextColor = getResources().getColor(R.color.black_333333);
    ...
    private int tabBackgroundResId = Color.parseColor("#00000000");
    ...
    private void updateTabStyles() {
        ...
        for (int i = 0; i < tabCount; i++) {
            ...
            v.setBackgroundResource(R.color.translucent);
